...
public class GlobalBehavior : MonoBehaviour {
    ...
    string eggCount = "Eggs on the Field: ";
    string killCount = "";
    ...
    public void UpdateControlState(string msg)
    {
        controlMode = "Press M to change control mode. CONTROL MODE : " + msg ;
    }

    public void UpdateWaypointState(string msg)
    {
        waypointSequence = "Press J to change traverse mode. TRAVERSE MODE : " + msg;
    }

     public void UpdateEggState(int msg)
    {
        eggCount = "Eggs on the Field: " + msg;
    }

     public void UpdateEnemyState(int msg)
    {
        killCount =  "     Enemies DESTROYED: " + msg;
    }

    public void updateMSG(){

       status =  controlMode + waypointSequence + eggCount + killCount + "\nPress Q to quit. ";
